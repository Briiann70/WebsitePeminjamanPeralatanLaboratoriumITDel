					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<h4 class="card-title">Data Peminjaman Barang</h4>
											...
											<tr>
												...
												<td>
													<?php if ($pinjambarang['status'] == 'menunggu') { ?>
														...
														<a href="#modalKembalikanPinjamBarang<?php echo $pinjambarang['id'] ?>" data-toggle="modal" title="Kembalikan" class="btn btn-xs btn-warning"><i class="fa fa-warning"></i>Di Kembalikan</a>
													<?php } else { ?>
														<div class="badge badge-success"><?php echo $pinjambarang['status'] ?></div>
													<?php } ?>
												</td>
...
<?php } ?>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<h4>Apakah User Sudah Mengembalikan Pinjamanan Ini ?</h4>
												</div>
												<div class="modal-footer no-bd">
			...
			if(isset($_POST['ubah']))
			{
		        ...
		        mysqli_query($conn,"UPDATE pinjambarang set status='$status' where id='$id'");
		        echo "<script>alert ('Status Peminjaman Telah Di-Update') </script>";
